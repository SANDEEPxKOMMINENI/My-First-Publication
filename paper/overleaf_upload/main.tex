...
\author{
    \textbf{Your Name}$^{1,*}$ \quad \textbf{P. V. R. Prasad}$^{1}$ \\
    $^{1}$Department of Computer Science and Engineering, KL University, India \\
    \texttt{\{your.email, pvr.prasad\}@kluniversity.in} \\
...
This work provides a foundation for understanding, detecting, and ultimately mitigating hallucinations in LLM systems, contributing toward more reliable and trustworthy AI applications. The code, dataset, and experimental framework are available at \texttt{https://github.com/username/llm-hallucination-research} to enable reproducibility and accelerate community progress on this critical challenge.
